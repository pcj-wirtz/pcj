...
GO
--esto es como se veria el resultado aplicado al rango derecho o al izquierdo 
...
VALUES ('Fargo')
GO 3333
--el numero de arriva es el numero de veces que se ejecutaria en bucle asta 3333 veces
